...
export default function NandGate({ inputA, inputB, setInputA, setInputB }: NandGateProps) {
  const output = !(inputA && inputB); // Inverted AND operation
      ...
      <div className="flex items-center justify-center gap-4 w-full h-48 relative">
        ...
        <div className="flex-1 max-w-60">
          <svg viewBox="0 0 200 100" className="w-full h-auto overflow-visible">
            ...
            />
            {/* Output Rail - Shifted right to accommodate the inversion bubble */}
            <path
              d="M 148,50 L 190,50"
              fill="none"
              strokeWidth="4"
            ...
            <path
              ...
              strokeWidth="3"
            />
            {/* Inversion Bubble Circle (NOT Indicator Node) */}
            <circle
              cx="144"
              cy="50"
              r="4"
