  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col font-sans">
      ...
      <header className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex justify-between items-center">
        <h1 className="text-xl font-bold tracking-wider text-amber-500">⚡ CIRCUIT THEORY ANALYZER</h1>
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-800">
        ...
        <section className="p-8 flex flex-col items-center justify-center min-h-100 bg-gray-950/50">
          <div className="text-center w-full flex flex-col items-center">
            <span className="text-xs font-mono text-amber-500/70 tracking-widest uppercase block mb-2">Interactive Workspace</span>
            <h2 className="text-3xl font-extrabold tracking-tight mb-8">{activeModule} Logic Simulation</h2>
            ...
            {activeModule !== 'AND' && activeModule !== 'OR' && (
              <p className="text-gray-500 italic max-w-md mx-auto">
                {activeModule} logic engine wrapper is ready. Waiting for implementation!
              </p>
            )}
          </div>
        </section>
        ...
        <section className="p-8 bg-gray-900/30 flex flex-col justify-between">
          <div>
            <span className="text-xs font-mono text-blue-400/70 tracking-widest uppercase block mb-2">Analysis & Documentation</span>
            <h2 className="text-2xl font-bold mb-6 text-gray-200">How the {activeModule} Circuit Works</h2>
            
            {/* RENDER DYNAMIC TRUTH TABLE */}
            {(activeModule === 'AND' || activeModule === 'OR') ? (
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Live Truth Table</h3>
                <TruthTable 
                  currentA={gateInputA} 
                  currentB={gateInputB} 
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-6">
                <p className="text-gray-500 text-sm italic">Truth table matrix for {activeModule} coming soon...</p>
              </div>
            )}
          </div>
